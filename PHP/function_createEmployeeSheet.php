<?php
    ...
    if (!empty($_POST["nom"] && $_POST["prenom"] && $_POST['service'] && $_POST["email"] && $_POST["tel"])) {
    ...
    function addContact(PDO $inDbh) {
        ...
        if( isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['service']) && isset($_POST['email'])
            ...
            if ( preg_match("`^0[0-9]([-. ]?\d{2}){4}[-. ]?$`",$_POST['tel']) ) {
                ...
                echo "Le télephone n'est pas valide";
            ...
            try {
                ...
                $query = "INSERT INTO `entreprise_carnet` (e_nom,e_prenom,e_service,e_mail,e_tel_fixe,e_tel_port,e_login_user) VALUES ('" . $inName . "','" . $inLName . "','" . $inService . "','" . $inMail . "','" . $inPhone . "','" . $inCellPhone . "','" . $_SESSION['id'] ."')";
                $sth   = $dbh ->query($query);
